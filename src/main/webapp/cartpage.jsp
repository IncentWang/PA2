...
<div class="right-column">
    ...
    <form name="orderForm" action="placeOrderServlet" method="get">
        ...
        <tr>
            <td> First Name: </td>
            <td> <input type = "text" id="fname" name = "fname" size = "30" required="" />
            </td>
        </tr>
            <tr>
                <td> Last Name: </td>
                <td> <input type = "text" id="lname" name = "lname" size = "30" required="" />
                </td>
            </tr>
            <tr>
                <td> Email: </td>
            ...
            <tr>
                ...
                <td> <input type = "text" id="address" name = "address" size = "30" required="" />
                </td>
            </tr>
            <tr>
                <td> Zipcode: </td>
            ...
            <tr>
                <td> City: </td>
                <td> <input type = "text" id="city" name = "city" size = "30" required="" />
                </td>
            </tr>
            <tr>
                <td> State: </td>
                <td> <input type = "text" id="state" name = "state" size = "30" required="" />
                </td>
            </tr>
            <tr>
                <td> Phone: </td>
                <td> <input type="text" id="phone" name="phone" pattern="(+[0-9])? [0-9]+" size = "30" required="" />
                </td>
            </tr>
        </table>
...
<%--
        ...
        <input type="text" id="zip" name="zip" style="width: 6em" pattern="[0-9]+"  onblur = "getPlace(this.value)" ><br><br>
...
--%>
       ...
       <input type="radio" id="overnight" name="shipping" value="overnight" checked="">
        ...
        <input type="tel" id="ccn" inputmode="numeric" autocomplete="cc-number" pattern="([0-9]{4} ){3}([0-9]{4})|[0-9]{16}">
        <br>

        <label for="month"> Month of Validation Date:</label>
        <br>
        ...
        <label for="year">Year of Validation Date:</label>
        <br>
        ...
        <br>
        <input type="text" id="cvv" name="cvv" value="" pattern="[0-9]{3}">
        <br>
        <input type="hidden" id="productNames" value="Galaxy_Fold" name="productNames">
        <br>
        <input type="hidden" id="price" value="799.99" name="price">
        <br>
